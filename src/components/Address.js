...
const AddressComponent = ({ address, setAddress, errors, handleChange }) => {
  const [states, setStates] = useState([]);
  const [districts, setDistricts] = useState([]);
  const [pincodes, setPincodes] = useState([]);
 
  // Manually map the data for states, districts, and pincodes
  const statesData = [
    ...
    { name: 'Arunachal Pradesh', districts: ['Anjaw', 'Changlang', 'Dibang Valley', 'East Kameng', 'East Siang', 'Itanagar Capital Complex', 'Kamle', 'Kra Daadi', 'Kurung Kumey', 'Lepa Rada', 'Lohit', 'Longding', 'Lower Dibang Valley', 'Lower Siang', 'Lower Subansiri', 'Namsai', 'Pakke Kessang', 'Papum Pare', 'Shi Yomi', 'Siang', 'Tawang', 'Tirap', 'Upper Siang', 'Upper Subansiri', 'West Kameng', 'West Siang'] },
    ...
    { name: 'Lakshadweep', districts: ['Agatti', 'Amini', 'Androth', 'Bithra', 'Chethlath', 'Kavaratti', 'Kadmath', 'Kalpeni', 'Kilthan', 'Minicoy'] },
    ...
    { name: 'Meghalaya', districts: ['East Garo Hills', 'East Jaintia Hills', 'East Khasi Hills', 'North Garo Hills', 'Ribhoi', 'South Garo Hills', 'South West Garo Hills', 'South West Khasi Hills', 'West Garo Hills', 'West Jaintia Hills', 'West Khasi Hills'] },
    ...
    { name: 'Telangana', districts: ['Adilabad', 'Bhadradri Kothagudem', 'Hyderabad', 'Jagtial', 'Jangaon', 'Jayashankar Bhupalapally', 'Jogulamba Gadwal', 'Kamareddy', 'Karimnagar', 'Khammam', 'Komaram Bheem Asifabad', 'Mahabubabad', 'Mahabubnagar', 'Mancherial', 'Medak', 'Medchal-Malkajgiri', 'Mulugu', 'Nagarkurnool', 'Nalgonda', 'Narayanpet', 'Nirmal', 'Nizamabad', 'Peddapalli', 'Rajanna Sircilla', 'Rangareddy', 'Sangareddy', 'Siddipet', 'Suryapet', 'Vikarabad', 'Wanaparthy', 'Warangal Rural', 'Warangal Urban', 'Yadadri Bhuvanagiri'] },
  ...
  const pincodeData = {
    ...
    Mangalore: ['575001', '575002', '575003'],
    // Add more pincodes for districts
  };
  ...
  const handleStateChange = (e) => {
    ...
    const state = statesData.find(state => state.name === selectedState);
    setDistricts(state ? state.districts : []);
    handleChange('address.state', selectedState);
  };
  ...
  const handleLocalAddressChange = (e) => {
    handleChange('address.localAddress', e.target.value);
  };
    ...
    <div>
      ...
      <Col sm="10">
        <Form.Control
          ...
          isInvalid={errors && errors.localAddress}
        />
        <Form.Control.Feedback type="invalid">
          {errors && errors.localAddress && errors.localAddress.message}
